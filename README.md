...
A simulated healthcare SOC environment built on VMware, designed to practice real-world threat detection and incident response in a HIPAA-relevant context.
...
* Internal firewall + primary NDR: OPNSense + Suricata (co-deployed, east-west)
